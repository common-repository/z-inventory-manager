...
class PW1_ZI3_Transactions00Db_Crud extends _PW1
{
	public $_;
	public $qb;
	public $sql;
...
// echo $sql . '<br>';
	...
	public function countLines( _PW1_Q $q = NULL )
	{
		$ret = 0;
	...
	public function updateLines( _PW1_Q $q, array $values )
	{
		$where = $q->getWhere();
		if( ! $where ){
			echo __METHOD__ . ': ' . __LINE__ . ': cannot proceed without conditions!<br>';
	...
	public function deleteLines( _PW1_Q $q )
	{
		$where = $q->getWhere();
		if( ! $where ){
			echo __METHOD__ . ': ' . __LINE__ . ': cannot proceed without conditions!<br>';
